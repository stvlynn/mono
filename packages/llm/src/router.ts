...
import { xsaiAnthropicAdapter, xsaiOpenAICompatibleAdapter, type LlmRunOptions, type ModelAdapter } from "./adapters/index.js";

const ADAPTERS: ModelAdapter[] = [xsaiAnthropicAdapter, xsaiOpenAICompatibleAdapter];
